...
namespace BansheeGz.BGSpline.Editor
{
	public abstract class BGSceneViewOverlayMenu<T> : BGSceneViewOverlay.SceneAction where T : BGSceneViewOverlayMenu<T>.AbstractMenu
	{
		...
		protected BGSceneViewOverlayMenu(BGSceneViewOverlay overlay, BGCurveEditorPointsSelection editorSelection) : base(overlay)
		{
		...
		public abstract class AbstractMenu : BGPopupMenu
		{
			...
			protected AbstractMenu(BGSceneViewOverlay overlay, BGCurveEditorPointsSelection editorSelection, string title) : base(title)
			{
		...
		{
			public LockMenuItem(Action action) : base(null, null, action) { }
