...
namespace BansheeGz.BGSpline.Editor
{
	public class BGSceneViewOverlayMenuSelection : BGSceneViewOverlayMenu<BGSceneViewOverlayMenuSelection.SelectionMenu>
	{
		...
		public BGSceneViewOverlayMenuSelection(BGSceneViewOverlay overlay, BGCurveEditorPointsSelection editorSelection) : base(overlay, editorSelection)
		{
		...
		{
			public SelectionMenu(BGSceneViewOverlay overlay, BGCurveEditorPointsSelection editorSelection) : base(overlay, editorSelection, "Selection menu") { }
