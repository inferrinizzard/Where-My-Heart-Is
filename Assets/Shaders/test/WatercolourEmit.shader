Shader "Custom/WatercolourEmissive" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		void surf (Input IN, inout SurfaceOutputStandard o) 
		{
			...
			o.Albedo = lerp(tint, softlight(tex2D (_PaperTex, IN.uv_PaperTex), tint), _PaperStrength);
			
			// Metallic and smoothness come from slider variables
			o.Metallic = _Metallic;
			o.Emission = fixed4(1-c,1-c,1-c,1)*_InkCol;
