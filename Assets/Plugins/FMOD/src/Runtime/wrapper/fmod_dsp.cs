...
namespace FMOD
{
	...
	*/
	...
	public enum DSP_DELAY : int
	{
		...
		MAXDELAY,
		/* Maximum delay in ms.      0  to 1000.   Default = 10. */
	}
	...
	public enum DSP_MULTIBAND_EQ : int
	{
		...
		A_FREQUENCY,
		/* (Type:float) - Band A: Significant frequency in Hz, cutoff [low/high pass, low/high shelf], center [notch, peaking, band-pass], phase transition point [all-pass]. 20 to 24000. Default = 8000. */
		A_Q,
		/* (Type:float) - Band A: Quality factory, resonance [low/high pass], bandwidth [notch, peaking, band-pass], phase transition sharpness [all-pass], unused [low/high shelf]. 0.1 to 10.0. Default = 0.707. */
		A_GAIN,
	...
	{
		ID,
		/* (Type:int) - ID of this Return DSP. Read-only.  Default = -1. */
	...
	public enum DSP_PAN : int
	{
		...
		_2D_HEIGHT_BLEND,
		/* (Type:float) - 2D Height blend.           When FMOD_DSP_PAN_SURROUND_SPEAKER_MODE has height speakers, control the blend between ground and height. 0.0 (ground speakers only) to 1.0 (top speakers only). Default = 0.0. */
	}
	...
	public enum DSP_CHANNELMIX : int
	{
		...
		OUTPUT_CH0,
		/* (Type:int)   - Input channel #0  Output channel.   0 to 31.  Default = 0. */
		OUTPUT_CH1,
		/* (Type:int)   - Input channel #1  Output channel.   0 to 31.  Default = 1. */
		OUTPUT_CH2,
		/* (Type:int)   - Input channel #2  Output channel.   0 to 31.  Default = 2. */
		OUTPUT_CH3,
		/* (Type:int)   - Input channel #3  Output channel.   0 to 31.  Default = 3. */
		OUTPUT_CH4,
		/* (Type:int)   - Input channel #4  Output channel.   0 to 31.  Default = 4. */
		OUTPUT_CH5,
		/* (Type:int)   - Input channel #5  Output channel.   0 to 31.  Default = 5. */
		OUTPUT_CH6,
		/* (Type:int)   - Input channel #6  Output channel.   0 to 31.  Default = 6. */
		OUTPUT_CH7,
		/* (Type:int)   - Input channel #7  Output channel.   0 to 31.  Default = 7. */
		OUTPUT_CH8,
		/* (Type:int)   - Input channel #8  Output channel.   0 to 31.  Default = 8. */
		OUTPUT_CH9,
		/* (Type:int)   - Input channel #9  Output channel.   0 to 31.  Default = 9. */
		OUTPUT_CH10,
		/* (Type:int)   - Input channel #10 Output channel.   0 to 31.  Default = 10. */
		OUTPUT_CH11,
		/* (Type:int)   - Input channel #11 Output channel.   0 to 31.  Default = 11. */
		OUTPUT_CH12,
		/* (Type:int)   - Input channel #12 Output channel.   0 to 31.  Default = 12. */
		OUTPUT_CH13,
		/* (Type:int)   - Input channel #13 Output channel.   0 to 31.  Default = 13. */
		OUTPUT_CH14,
		/* (Type:int)   - Input channel #14 Output channel.   0 to 31.  Default = 14. */
		OUTPUT_CH15,
		/* (Type:int)   - Input channel #15 Output channel.   0 to 31.  Default = 15. */
		OUTPUT_CH16,
		/* (Type:int)   - Input channel #16 Output channel.   0 to 31.  Default = 16. */
		OUTPUT_CH17,
		/* (Type:int)   - Input channel #17 Output channel.   0 to 31.  Default = 17. */
		OUTPUT_CH18,
		/* (Type:int)   - Input channel #18 Output channel.   0 to 31.  Default = 18. */
		OUTPUT_CH19,
		/* (Type:int)   - Input channel #19 Output channel.   0 to 31.  Default = 19. */
		OUTPUT_CH20,
		/* (Type:int)   - Input channel #20 Output channel.   0 to 31.  Default = 20. */
		OUTPUT_CH21,
		/* (Type:int)   - Input channel #21 Output channel.   0 to 31.  Default = 21. */
		OUTPUT_CH22,
		/* (Type:int)   - Input channel #22 Output channel.   0 to 31.  Default = 22. */
		OUTPUT_CH23,
		/* (Type:int)   - Input channel #23 Output channel.   0 to 31.  Default = 23. */
		OUTPUT_CH24,
		/* (Type:int)   - Input channel #24 Output channel.   0 to 31.  Default = 24. */
		OUTPUT_CH25,
		/* (Type:int)   - Input channel #25 Output channel.   0 to 31.  Default = 25. */
		OUTPUT_CH26,
		/* (Type:int)   - Input channel #26 Output channel.   0 to 31.  Default = 26. */
		OUTPUT_CH27,
		/* (Type:int)   - Input channel #27 Output channel.   0 to 31.  Default = 27. */
		OUTPUT_CH28,
		/* (Type:int)   - Input channel #28 Output channel.   0 to 31.  Default = 28. */
		OUTPUT_CH29,
		/* (Type:int)   - Input channel #29 Output channel.   0 to 31.  Default = 29. */
		OUTPUT_CH30,
		/* (Type:int)   - Input channel #30 Output channel.   0 to 31.  Default = 30. */
		OUTPUT_CH31,
		/* (Type:int)   - Input channel #31 Output channel.   0 to 31.  Default = 31. */
	}
	...
	public enum DSP_OBJECTPAN : int
	{
		...
		/* (Type:int)   - 3D Rolloff.                FMOD_DSP_PAN_3D_ROLLOFF_LINEARSQUARED to FMOD_DSP_PAN_3D_ROLLOFF_CUSTOM.  Default = FMOD_DSP_PAN_3D_ROLLOFF_LINEARSQUARED. */
		_3D_MIN_DISTANCE,
		/* (Type:float) - 3D Min Distance.           0.0 to 1e+19f.  Default = 1.0. */
		_3D_MAX_DISTANCE,
		/* (Type:float) - 3D Max Distance.           0.0 to 1e+19f.  Default = 20.0. */
		_3D_EXTENT_MODE,
		/* (Type:int)   - 3D Extent Mode.            FMOD_DSP_PAN_3D_EXTENT_MODE_AUTO to FMOD_DSP_PAN_3D_EXTENT_MODE_OFF.  Default = FMOD_DSP_PAN_3D_EXTENT_MODE_AUTO. */
		_3D_SOUND_SIZE,
		/* (Type:float) - 3D Sound Size.             0.0 to 1e+19f.  Default = 0.0. */
		_3D_MIN_EXTENT,
		/* (Type:float) - 3D Min Extent.             0.0 (degrees) to 360.0 (degrees).  Default = 0.0. */
		OVERALL_GAIN,
		/* (Type:data)  - Overall gain.              For information only, not set by user.  Data of type FMOD_DSP_PARAMETER_DATA_TYPE_OVERALLGAIN to provide to FMOD, to allow FMOD to know the DSP is scaling the signal for virtualization purposes. */
